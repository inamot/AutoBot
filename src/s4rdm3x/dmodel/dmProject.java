...
public class dmProject
{
    ...
    public void toStringClasses()
    {
    	for( String m_class : m_classes.keySet() )
    	{
    		System.out.println( m_class );
    	}
    }
    
    public void toStringBlackList()
    {
    	for( BlackListItem item : m_blackList )
    	{
    		System.out.println( "BlackListItem: " + item.m_name );
    	}
    }
    
    public String toString()
    {
    	return "\n m_constants: " + m_constants + "\n m_constantDependencies: " + m_constantDependencies;
    }
